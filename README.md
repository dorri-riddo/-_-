...
▲ 당일 복용해야 할 약이 보이며, 복용 이후 체크박스로 표시할 수 있습니다.
...
▲ 복용해야 할 약을 추가, 수정, 삭제할 수 있습니다. <br>
약의 복용 기간, 요일, 하루 횟수 및 복용 시간을 정할 수 있습니다. <br>
약 설정에 맞춰 복용 알람이 울립니다.
...
▲ 설정에 맞춰 날짜/요일 별로 복용할 약을 달력으로 보여줍니다.<br>
각 날짜별로 그날 증상 및 복용 이후 변화를 메모할 수 있습니다.
...
▲ 사용자가 원하는 기간 동안 복용하였던 약 목록과 그날의 메모를 PDF 로 저장할 수 있습니다.<br>
 파일 저장을 위하여 사용자에게 미디어 접근 허용을 필요로 합니다.
